...
You are tasked with building the UI for an E-commerce Listing Page based on the provided Figma design. The page should display a list of products, and each product should have an option to either view the product or add it to the cart. There will be no dedicated product page, so when a user clicks "View Product," they should be redirected to a custom Thank You page. Additionally, when users click "Add to Cart," a modal should open, as per ui design.
...
5. Mock Data:
   ...
   Modal Implementation: The "Add to Cart" button should trigger a modal displaying the product’s details and a confirmation button to add the product to the cart.

# Submission Instructions

## Evaluation Creteria

How closely does the final design align with the provided Figma file?

Code Quality: Are the components modular, cleanly structured, and reusable?

Functionality: Does the "View Product" button properly redirect to the "Thank You" page?

Does the "Add to Cart" modal function correctly and display as expected?

Attention to Detail: Overall polish, including hover states, modals, and the user experience.
...
When a user clicks "View Product," they are redirected to a custom "Thank You" page. Since there was no product detail page required, I designed a simple page thanking the user for their interest. after clicking the "View more products" in thanking you page user redirected to Product list page
